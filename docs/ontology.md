...
- **Entity / Company**: named object; a Company extends Entity with stable identifiers such as CIK.
- **Source**: immutable retrieved material, versioned by checksum; upstream changes create a successor source.
- **Observation**: a directly extractable statement from a source, with a locator.
- **Claim**: an evaluable statement. A claim is never assumed to be a source fact.
- **Evidence**: directional link from a claim to an observation and source.
